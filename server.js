...
function server(){
  ...
  server = http.createServer(function(req, res) {
    ...
    return res.end(`<!DOCTYPE html><html><head><meta charset="utf-8"><title>歡迎使用daonodess</title><style>body {text-align:center;}</style></head><body><div><h1>DaoNodeSS</h1><p>看到此頁面代表程序正確運行</p><p>本程式改自shadowsocks-heroku，目的是把這個專案Docker化</p><p>並支援自己設定參數</p></div></body></html>`);
  });
